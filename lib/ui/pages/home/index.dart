...
// link to packages from cinstants;
export 'package:application/core/constants/constants.dart';

// link to packages from the rest-api.
export 'package:application/core/models/pokemon.dart';
export 'package:application/core/repositories/pokemon_repository.dart';
